...
INSERT INTO `chitietdonhang` VALUES (103,98,4,1,213400),(104,98,1,1,125000),(105,98,14,1,123120),(106,98,10,1,213400),(107,99,4,2,213400),(108,99,1,1,125000),(109,99,18,1,123120),(110,100,1,2,125000);
...
INSERT INTO `chitietkho` VALUES (2,1,1,323),(3,1,2,56),(4,1,3,92),(5,1,4,273),(6,1,5,100),(7,1,6,100),(8,1,8,100),(9,1,9,100),(10,1,10,92),(11,1,11,100),(12,1,12,0),(13,1,13,100),(14,1,14,99),(15,1,18,0),(16,1,19,0),(17,1,20,100),(18,1,21,100),(19,1,22,96),(20,1,23,100),(21,1,24,100),(22,1,25,100),(23,1,26,1000),(24,1,27,100),(25,1,28,100),(26,1,37,94);
...
INSERT INTO `donhang` VALUES (98,105,'2024-01-02','Đã xác nhận',674920,'Đã thanh toán','Giao hàng thành công'),(99,106,'2024-01-04','Chưa xác nhận',674920,'Chưa thanh toán','Chưa giao hàng'),(100,107,'2024-01-04','Đã xác nhận',250000,'Chưa thanh toán','Chưa giao hàng');
...
INSERT INTO `hoadonnhap` VALUES (1,'2023-05-29',1,1,5884000),(2,'2023-05-30',1,1,2134000),(3,'2023-06-02',1,1,1067000),(4,'2023-06-02',1,1,22570000),(5,'2023-10-17',1,2,2134000),(6,'2023-10-17',1,2,21340000),(7,'2023-10-18',1,3,5499200),(8,'2023-10-19',1,1,4634000),(9,'2023-12-16',1,1,44814000);
...
INSERT INTO `nguoidung` VALUES (1,'Đinh Thành Luân','2023-05-10','0000-00-00','Hà Nội','luan2k2hy@gmail.com','0971877014'),(2,'Đinh Thành Luân','2002-09-15','0000-00-00','Hưng Yên','luanhy@gmaik.com','0971877014'),(3,'Nguyễn Quang Anh','2023-10-07','0000-00-00','Đặng Lễ, Ân Thi, Hưng Yên','anh@gmail.com','0986270123'),(4,'Vũ','2023-10-27','0000-00-00','Mỹ Hào, Hưng Yên','Vu@gmail.com','0976665434'),(5,'vuhieu','2001-08-19','0000-00-00','An Thi,Hung Yen','vhieu@gmail.com','0969499375'),(6,'Phí Đức Thanh','2024-01-27','Nam','Ân Thi - Hưng Yên','thanh@gmail.com','0976767898');
...
INSERT INTO `taikhoan` VALUES (1,1,'luan@gmail.com','123456','2023-05-10','2023-05-10','1','admin'),(2,2,'luan2k2hy@gmail.com','150922','2023-05-10',NULL,'1','client'),(3,3,'anh@gmail.com','123456','2023-10-13',NULL,'1','client'),(4,4,'Vu@gmail.com','123456','2023-10-13',NULL,'1','client'),(5,5,'123456','123456','2023-10-20',NULL,'1','client'),(6,6,'thanh@gmail.com','1','2024-01-05',NULL,'1','client');
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `CreatetaiKhoan`(
    hoTen varchar(100),
    ngaySinh date,
    gioiTinh varchar(20),
    diaChi varchar(200),
...
BEGIN
    ...
    -- Kiểm tra xem email đã tồn tại trong bảng nguoidung hay chưa
    SELECT maNguoiDung INTO existingUserId FROM nguoidung WHERE nguoidung.email = email LIMIT 1;

    -- Nếu email đã tồn tại, không thêm tài khoản mới
    IF existingUserId IS NOT NULL THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Email đã tồn tại trong hệ thống. Không thể thêm tài khoản.';
    ELSE
        -- Nếu email chưa tồn tại, thêm thông tin người dùng và tài khoản mới
        INSERT INTO nguoidung(hoTen, ngaySinh, gioiTinh, diaChi, email, sdt) 
        VALUES (hoTen, ngaySinh, gioiTinh, diaChi, email, sdt);
...
-- Dump completed on 2024-01-05  1:37:59
